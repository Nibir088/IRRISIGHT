...
def create_backbone(pretrained=True, weights="sentinel", backbone_type="swin"):
    """
...
class PretrainedModel(nn.Module):
    ...
    Returns:
        Dict:
            ...
            attention (Tensor or None): Attention weights (if any).
    """
    def __init__(
        self,
        model_name: str,
        ...
        **kwargs
        ...
        self.backbone = create_backbone(pretrained, weights, model_name)
