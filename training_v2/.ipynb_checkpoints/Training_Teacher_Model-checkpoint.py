...
from models_v3.TeacherModel import TeacherModel
# from models.TeacherStudentModel_v1 import TeacherStudentKIIM
from utils.train_config import save_experiment_config
import torch
torch.set_float32_matmul_precision('high')

@hydra.main(config_path="/project/biocomplexity/wyr6fx(Nibir)/NeurIPS_Irrigation_Mapping_Model/KIIM/config", config_name="supervised_training", version_base="1.2")
