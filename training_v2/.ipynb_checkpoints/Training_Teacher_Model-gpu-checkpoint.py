...
def train(cfg: DictConfig) -> None:
    ...
    # print(model)
    model = TeacherModel.load_from_checkpoint(
        checkpoint_path="/project/biocomplexity/wyr6fx(Nibir)/NeurIPS_Irrigation_Mapping_Model/Output_v2/holdout/Arizona1_/trained/pretrained_attnmask_projcrop_/kiim/rgb_landmask_cropmask_vegetation_/result_stats/checkpoints/epoch=17-val_iou_macro_irr=0.920.ckpt",  # <-- path to your .ckpt file
        **cfg
    )
