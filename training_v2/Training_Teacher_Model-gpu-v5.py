...
@hydra.main(config_path="/project/biocomplexity/wyr6fx(Nibir)/NeurIPS_Irrigation_Mapping_Model/KIIM/config", config_name="supervised_training_gpu_v5", version_base="1.2")
